...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/host/dev-panel': { kind: 'none', reason: 'Loopback review panel renders workspace and git state in the browser; registers nothing model-facing.' },
  'packages/client/ui-dev-panel': { kind: 'none', reason: 'Browser-side review panel renders workspace and git state; registers nothing model-facing.' },
