...
- `@deepseek-ai/dsh-client-ui-dev-panel`（[`packages/client/ui-dev-panel/src/index.ts`](../packages/client/ui-dev-panel/src/index.ts)）
...
- `@deepseek-ai/dsh-host-dev-panel` — 需要 `webServer` · `shell`（[`packages/host/dev-panel/src/index.ts`](../packages/host/dev-panel/src/index.ts)）
