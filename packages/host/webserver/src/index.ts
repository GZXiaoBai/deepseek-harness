 ...
 * and serves no files; the composing application owns dist serving. The Tauri
 * Desktop sidecar exposes this server on a private loopback origin; the native
 * shell owns navigation and this package never prints the URL.
