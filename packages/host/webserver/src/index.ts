 ...
 * Browsers use this carrier directly; the Tauri Desktop shell starts its
 * packaged sidecar at `http://127.0.0.1:<ephemeral-port>` and navigates the
 * WebView to that exact origin. A future `file://` plus IPC host is a separate
 * architecture rather than an alias. The URL line belongs to the shell.
 */
