...
export class AgentPresets extends TypertRemoteService {
  ...
  async list(): Promise<AgentPreset[]> {
    ...
    const packageBase = packages === undefined ? this.harnessBase : this.selfCtx.baseUrl ?? this.harnessBase
    return await discoverPresets(
      this.resolvedRoots,
      packageBase,
      packages === undefined ? undefined : (specifier, base) => packages.packageOf(specifier, base) !== undefined,
