...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    summary: 'Host adapter for package metadata stored in an embedded runtime.',
    description: 'Host adapter for package metadata stored in an embedded runtime.',
    methods: [
      {
        signature: 'resolve(spec: string): string | undefined',
        description: 'Resolve one package\'s exported manifest.',
        parameters: [{ name: 'spec', description: 'Bare package name from a Loader entry.' }],
