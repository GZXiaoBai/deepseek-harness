...
[Credential records and flows](2026-08-13-credential-records-and-authorization-flows.md) remains the generic credential authority. [Desktop wrapper](../../archived/architecture/2026-09-10-desktop-web-wrapper.md) owns the transport composition.
